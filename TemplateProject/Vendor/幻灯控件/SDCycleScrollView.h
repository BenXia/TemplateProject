...
@property (nonatomic, strong) UIColor *notSelectDotColor;
...
@property (nonatomic, assign) BOOL needChangeHeight;

// >>>>>>>>>>>>>>>>>>>>>>>>> 构造方法

+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame infiniteLoop:(BOOL)infiniteLoop imagesGroup:(NSArray *)imagesGroup;

+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame infiniteLoop:(BOOL)infiniteLoop imageURLStringsGroup:(NSArray *)imageURLStringsGroup;
